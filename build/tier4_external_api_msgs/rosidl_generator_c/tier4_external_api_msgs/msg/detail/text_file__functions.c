...
tier4_external_api_msgs__msg__TextFile__create()
{
  ...
  tier4_external_api_msgs__msg__TextFile * msg = (tier4_external_api_msgs__msg__TextFile *)allocator.allocate(sizeof(tier4_external_api_msgs__msg__TextFile), allocator.state);
  if (!msg) {
    return NULL;
  }
...
tier4_external_api_msgs__msg__TextFile__Sequence__init(tier4_external_api_msgs__msg__TextFile__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (tier4_external_api_msgs__msg__TextFile *)allocator.zero_allocate(size, sizeof(tier4_external_api_msgs__msg__TextFile), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tier4_external_api_msgs__msg__TextFile__Sequence * array = (tier4_external_api_msgs__msg__TextFile__Sequence *)allocator.allocate(sizeof(tier4_external_api_msgs__msg__TextFile__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  ...
  tier4_external_api_msgs__msg__TextFile__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    tier4_external_api_msgs__msg__TextFile * data =
      (tier4_external_api_msgs__msg__TextFile *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tier4_external_api_msgs__msg__TextFile__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          tier4_external_api_msgs__msg__TextFile__fini(&output->data[i]);
        }
        return false;
      }
    }
