...
void fetch_function__CalibrationStatusArray__status_array(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const tier4_external_api_msgs::msg::CalibrationStatus *>(
    get_const_function__CalibrationStatusArray__status_array(untyped_member, index));
  auto & value = *reinterpret_cast<tier4_external_api_msgs::msg::CalibrationStatus *>(untyped_value);
  value = item;
}

void assign_function__CalibrationStatusArray__status_array(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<tier4_external_api_msgs::msg::CalibrationStatus *>(
    get_function__CalibrationStatusArray__status_array(untyped_member, index));
  const auto & value = *reinterpret_cast<const tier4_external_api_msgs::msg::CalibrationStatus *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember CalibrationStatusArray_message_member_array[2] = {
  ...
  },
  {
    ...
    fetch_function__CalibrationStatusArray__status_array,  // fetch(index, &value) function pointer
    assign_function__CalibrationStatusArray__status_array,  // assign(index, value) function pointer
