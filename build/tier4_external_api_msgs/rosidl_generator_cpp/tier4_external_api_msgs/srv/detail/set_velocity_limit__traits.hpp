...
inline void to_flow_style_yaml(
  const SetVelocityLimit_Request & msg,
  std::ostream & out)
{
  out << "{";
  // member: velocity
...
inline std::string to_yaml(const SetVelocityLimit_Request & msg, bool use_flow_style = false)
{
...
inline void to_flow_style_yaml(
  const SetVelocityLimit_Response & msg,
  std::ostream & out)
{
  out << "{";
  // member: status
...
inline std::string to_yaml(const SetVelocityLimit_Response & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
