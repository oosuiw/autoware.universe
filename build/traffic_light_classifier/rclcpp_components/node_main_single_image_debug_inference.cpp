...
#define NODE_MAIN_LOGGER_NAME "single_image_debug_inference"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libsingle_image_debug_inference_node.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<traffic_light::SingleImageDebugInferenceNode>";
