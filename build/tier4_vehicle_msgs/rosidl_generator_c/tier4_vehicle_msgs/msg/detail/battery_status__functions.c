...
tier4_vehicle_msgs__msg__BatteryStatus__create()
{
  ...
  tier4_vehicle_msgs__msg__BatteryStatus * msg = (tier4_vehicle_msgs__msg__BatteryStatus *)allocator.allocate(sizeof(tier4_vehicle_msgs__msg__BatteryStatus), allocator.state);
  if (!msg) {
    return NULL;
  }
...
tier4_vehicle_msgs__msg__BatteryStatus__Sequence__init(tier4_vehicle_msgs__msg__BatteryStatus__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (tier4_vehicle_msgs__msg__BatteryStatus *)allocator.zero_allocate(size, sizeof(tier4_vehicle_msgs__msg__BatteryStatus), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tier4_vehicle_msgs__msg__BatteryStatus__Sequence * array = (tier4_vehicle_msgs__msg__BatteryStatus__Sequence *)allocator.allocate(sizeof(tier4_vehicle_msgs__msg__BatteryStatus__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  ...
  tier4_vehicle_msgs__msg__BatteryStatus__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    tier4_vehicle_msgs__msg__BatteryStatus * data =
      (tier4_vehicle_msgs__msg__BatteryStatus *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tier4_vehicle_msgs__msg__BatteryStatus__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          tier4_vehicle_msgs__msg__BatteryStatus__fini(&output->data[i]);
        }
        return false;
      }
    }
