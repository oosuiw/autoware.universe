...
tier4_vehicle_msgs__msg__Shift__create()
{
  ...
  tier4_vehicle_msgs__msg__Shift * msg = (tier4_vehicle_msgs__msg__Shift *)allocator.allocate(sizeof(tier4_vehicle_msgs__msg__Shift), allocator.state);
  if (!msg) {
    return NULL;
  }
...
tier4_vehicle_msgs__msg__Shift__Sequence__init(tier4_vehicle_msgs__msg__Shift__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (tier4_vehicle_msgs__msg__Shift *)allocator.zero_allocate(size, sizeof(tier4_vehicle_msgs__msg__Shift), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tier4_vehicle_msgs__msg__Shift__Sequence * array = (tier4_vehicle_msgs__msg__Shift__Sequence *)allocator.allocate(sizeof(tier4_vehicle_msgs__msg__Shift__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  ...
  tier4_vehicle_msgs__msg__Shift__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    tier4_vehicle_msgs__msg__Shift * data =
      (tier4_vehicle_msgs__msg__Shift *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tier4_vehicle_msgs__msg__Shift__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          tier4_vehicle_msgs__msg__Shift__fini(&output->data[i]);
        }
        return false;
      }
    }
