...
tier4_vehicle_msgs__msg__TurnSignal__create()
{
  ...
  tier4_vehicle_msgs__msg__TurnSignal * msg = (tier4_vehicle_msgs__msg__TurnSignal *)allocator.allocate(sizeof(tier4_vehicle_msgs__msg__TurnSignal), allocator.state);
  if (!msg) {
    return NULL;
  }
...
tier4_vehicle_msgs__msg__TurnSignal__Sequence__init(tier4_vehicle_msgs__msg__TurnSignal__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (tier4_vehicle_msgs__msg__TurnSignal *)allocator.zero_allocate(size, sizeof(tier4_vehicle_msgs__msg__TurnSignal), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tier4_vehicle_msgs__msg__TurnSignal__Sequence * array = (tier4_vehicle_msgs__msg__TurnSignal__Sequence *)allocator.allocate(sizeof(tier4_vehicle_msgs__msg__TurnSignal__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  ...
  tier4_vehicle_msgs__msg__TurnSignal__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    tier4_vehicle_msgs__msg__TurnSignal * data =
      (tier4_vehicle_msgs__msg__TurnSignal *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tier4_vehicle_msgs__msg__TurnSignal__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          tier4_vehicle_msgs__msg__TurnSignal__fini(&output->data[i]);
        }
        return false;
      }
    }
