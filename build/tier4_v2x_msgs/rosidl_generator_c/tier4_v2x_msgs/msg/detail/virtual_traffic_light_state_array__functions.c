...
tier4_v2x_msgs__msg__VirtualTrafficLightStateArray__create()
{
  ...
  tier4_v2x_msgs__msg__VirtualTrafficLightStateArray * msg = (tier4_v2x_msgs__msg__VirtualTrafficLightStateArray *)allocator.allocate(sizeof(tier4_v2x_msgs__msg__VirtualTrafficLightStateArray), allocator.state);
  if (!msg) {
    return NULL;
  }
...
tier4_v2x_msgs__msg__VirtualTrafficLightStateArray__Sequence__init(tier4_v2x_msgs__msg__VirtualTrafficLightStateArray__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (tier4_v2x_msgs__msg__VirtualTrafficLightStateArray *)allocator.zero_allocate(size, sizeof(tier4_v2x_msgs__msg__VirtualTrafficLightStateArray), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tier4_v2x_msgs__msg__VirtualTrafficLightStateArray__Sequence * array = (tier4_v2x_msgs__msg__VirtualTrafficLightStateArray__Sequence *)allocator.allocate(sizeof(tier4_v2x_msgs__msg__VirtualTrafficLightStateArray__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  ...
  tier4_v2x_msgs__msg__VirtualTrafficLightStateArray__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    tier4_v2x_msgs__msg__VirtualTrafficLightStateArray * data =
      (tier4_v2x_msgs__msg__VirtualTrafficLightStateArray *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tier4_v2x_msgs__msg__VirtualTrafficLightStateArray__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          tier4_v2x_msgs__msg__VirtualTrafficLightStateArray__fini(&output->data[i]);
        }
        return false;
      }
    }
