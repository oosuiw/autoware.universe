...
void tier4_api_msgs__msg__AwapiVehicleStatus__rosidl_typesupport_introspection_c__AwapiVehicleStatus_init_function(
...
void tier4_api_msgs__msg__AwapiVehicleStatus__rosidl_typesupport_introspection_c__AwapiVehicleStatus_fini_function(void * message_memory)
{
  tier4_api_msgs__msg__AwapiVehicleStatus__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember tier4_api_msgs__msg__AwapiVehicleStatus__rosidl_typesupport_introspection_c__AwapiVehicleStatus_message_member_array[16] = {
  {
    "header",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers tier4_api_msgs__msg__AwapiVehicleStatus__rosidl_typesupport_introspection_c__AwapiVehicleStatus_message_members = {
  "tier4_api_msgs__msg",  // message namespace
  "AwapiVehicleStatus",  // message name
  16,  // number of fields
  sizeof(tier4_api_msgs__msg__AwapiVehicleStatus),
  tier4_api_msgs__msg__AwapiVehicleStatus__rosidl_typesupport_introspection_c__AwapiVehicleStatus_message_member_array,  // message members
  tier4_api_msgs__msg__AwapiVehicleStatus__rosidl_typesupport_introspection_c__AwapiVehicleStatus_init_function,  // function to initialize message memory (memory has to be allocated)
  tier4_api_msgs__msg__AwapiVehicleStatus__rosidl_typesupport_introspection_c__AwapiVehicleStatus_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t tier4_api_msgs__msg__AwapiVehicleStatus__rosidl_typesupport_introspection_c__AwapiVehicleStatus_message_type_support_handle = {
  0,
  &tier4_api_msgs__msg__AwapiVehicleStatus__rosidl_typesupport_introspection_c__AwapiVehicleStatus_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tier4_api_msgs, msg, AwapiVehicleStatus)() {
  tier4_api_msgs__msg__AwapiVehicleStatus__rosidl_typesupport_introspection_c__AwapiVehicleStatus_message_member_array[0].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, std_msgs, msg, Header)();
  tier4_api_msgs__msg__AwapiVehicleStatus__rosidl_typesupport_introspection_c__AwapiVehicleStatus_message_member_array[1].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, geometry_msgs, msg, Pose)();
  tier4_api_msgs__msg__AwapiVehicleStatus__rosidl_typesupport_introspection_c__AwapiVehicleStatus_message_member_array[2].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tier4_api_msgs, msg, Euler)();
  tier4_api_msgs__msg__AwapiVehicleStatus__rosidl_typesupport_introspection_c__AwapiVehicleStatus_message_member_array[3].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, geographic_msgs, msg, GeoPoint)();
  if (!tier4_api_msgs__msg__AwapiVehicleStatus__rosidl_typesupport_introspection_c__AwapiVehicleStatus_message_type_support_handle.typesupport_identifier) {
    tier4_api_msgs__msg__AwapiVehicleStatus__rosidl_typesupport_introspection_c__AwapiVehicleStatus_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &tier4_api_msgs__msg__AwapiVehicleStatus__rosidl_typesupport_introspection_c__AwapiVehicleStatus_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
