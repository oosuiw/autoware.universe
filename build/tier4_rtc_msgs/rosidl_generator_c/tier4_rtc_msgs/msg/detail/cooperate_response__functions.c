...
tier4_rtc_msgs__msg__CooperateResponse__create()
{
  ...
  tier4_rtc_msgs__msg__CooperateResponse * msg = (tier4_rtc_msgs__msg__CooperateResponse *)allocator.allocate(sizeof(tier4_rtc_msgs__msg__CooperateResponse), allocator.state);
  if (!msg) {
    return NULL;
  }
...
tier4_rtc_msgs__msg__CooperateResponse__Sequence__init(tier4_rtc_msgs__msg__CooperateResponse__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (tier4_rtc_msgs__msg__CooperateResponse *)allocator.zero_allocate(size, sizeof(tier4_rtc_msgs__msg__CooperateResponse), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tier4_rtc_msgs__msg__CooperateResponse__Sequence * array = (tier4_rtc_msgs__msg__CooperateResponse__Sequence *)allocator.allocate(sizeof(tier4_rtc_msgs__msg__CooperateResponse__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  ...
  tier4_rtc_msgs__msg__CooperateResponse__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    tier4_rtc_msgs__msg__CooperateResponse * data =
      (tier4_rtc_msgs__msg__CooperateResponse *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tier4_rtc_msgs__msg__CooperateResponse__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          tier4_rtc_msgs__msg__CooperateResponse__fini(&output->data[i]);
        }
        return false;
      }
    }
