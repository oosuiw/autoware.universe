...
tier4_rtc_msgs__msg__CooperateStatusArray__create()
{
  ...
  tier4_rtc_msgs__msg__CooperateStatusArray * msg = (tier4_rtc_msgs__msg__CooperateStatusArray *)allocator.allocate(sizeof(tier4_rtc_msgs__msg__CooperateStatusArray), allocator.state);
  if (!msg) {
    return NULL;
  }
...
tier4_rtc_msgs__msg__CooperateStatusArray__Sequence__init(tier4_rtc_msgs__msg__CooperateStatusArray__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (tier4_rtc_msgs__msg__CooperateStatusArray *)allocator.zero_allocate(size, sizeof(tier4_rtc_msgs__msg__CooperateStatusArray), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tier4_rtc_msgs__msg__CooperateStatusArray__Sequence * array = (tier4_rtc_msgs__msg__CooperateStatusArray__Sequence *)allocator.allocate(sizeof(tier4_rtc_msgs__msg__CooperateStatusArray__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  ...
  tier4_rtc_msgs__msg__CooperateStatusArray__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    tier4_rtc_msgs__msg__CooperateStatusArray * data =
      (tier4_rtc_msgs__msg__CooperateStatusArray *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tier4_rtc_msgs__msg__CooperateStatusArray__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          tier4_rtc_msgs__msg__CooperateStatusArray__fini(&output->data[i]);
        }
        return false;
      }
    }
