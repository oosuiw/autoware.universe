...
#ifndef TIER4_RTC_MSGS__SRV__DETAIL__AUTO_MODE_WITH_MODULE__FUNCTIONS_H_
#define TIER4_RTC_MSGS__SRV__DETAIL__AUTO_MODE_WITH_MODULE__FUNCTIONS_H_
...
/// Initialize srv/AutoModeWithModule message.
/**
...
/// Finalize srv/AutoModeWithModule message.
/**
...
/// Create srv/AutoModeWithModule message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * tier4_rtc_msgs__srv__AutoModeWithModule_Request__init().
...
/// Destroy srv/AutoModeWithModule message.
/**
 * It calls
 * tier4_rtc_msgs__srv__AutoModeWithModule_Request__fini()
...
/// Check for srv/AutoModeWithModule message equality.
/**
...
/// Copy a srv/AutoModeWithModule message.
/**
...
/// Initialize array of srv/AutoModeWithModule messages.
/**
...
/// Finalize array of srv/AutoModeWithModule messages.
/**
 * It calls
 * tier4_rtc_msgs__srv__AutoModeWithModule_Request__fini()
...
/// Create array of srv/AutoModeWithModule messages.
/**
 * It allocates the memory for the array and calls
 * tier4_rtc_msgs__srv__AutoModeWithModule_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/AutoModeWithModule messages.
/**
 * It calls
 * tier4_rtc_msgs__srv__AutoModeWithModule_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/AutoModeWithModule message array equality.
/**
...
/// Copy an array of srv/AutoModeWithModule messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * tier4_rtc_msgs__srv__AutoModeWithModule_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_tier4_rtc_msgs
...
/**
 * It calls
 * tier4_rtc_msgs__srv__AutoModeWithModule_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_tier4_rtc_msgs
...
/**
 * It allocates the memory for the array and calls
 * tier4_rtc_msgs__srv__AutoModeWithModule_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_tier4_rtc_msgs
...
/**
 * It calls
 * tier4_rtc_msgs__srv__AutoModeWithModule_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // TIER4_RTC_MSGS__SRV__DETAIL__AUTO_MODE_WITH_MODULE__FUNCTIONS_H_
