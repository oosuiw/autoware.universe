...
void tier4_planning_msgs__msg__AvoidanceDebugMsg__rosidl_typesupport_introspection_c__AvoidanceDebugMsg_init_function(
...
void tier4_planning_msgs__msg__AvoidanceDebugMsg__rosidl_typesupport_introspection_c__AvoidanceDebugMsg_fini_function(void * message_memory)
{
  tier4_planning_msgs__msg__AvoidanceDebugMsg__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember tier4_planning_msgs__msg__AvoidanceDebugMsg__rosidl_typesupport_introspection_c__AvoidanceDebugMsg_message_member_array[9] = {
  {
    "object_id",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers tier4_planning_msgs__msg__AvoidanceDebugMsg__rosidl_typesupport_introspection_c__AvoidanceDebugMsg_message_members = {
  ...
  tier4_planning_msgs__msg__AvoidanceDebugMsg__rosidl_typesupport_introspection_c__AvoidanceDebugMsg_message_member_array,  // message members
  tier4_planning_msgs__msg__AvoidanceDebugMsg__rosidl_typesupport_introspection_c__AvoidanceDebugMsg_init_function,  // function to initialize message memory (memory has to be allocated)
  tier4_planning_msgs__msg__AvoidanceDebugMsg__rosidl_typesupport_introspection_c__AvoidanceDebugMsg_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t tier4_planning_msgs__msg__AvoidanceDebugMsg__rosidl_typesupport_introspection_c__AvoidanceDebugMsg_message_type_support_handle = {
  0,
  &tier4_planning_msgs__msg__AvoidanceDebugMsg__rosidl_typesupport_introspection_c__AvoidanceDebugMsg_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tier4_planning_msgs, msg, AvoidanceDebugMsg)() {
  if (!tier4_planning_msgs__msg__AvoidanceDebugMsg__rosidl_typesupport_introspection_c__AvoidanceDebugMsg_message_type_support_handle.typesupport_identifier) {
    tier4_planning_msgs__msg__AvoidanceDebugMsg__rosidl_typesupport_introspection_c__AvoidanceDebugMsg_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &tier4_planning_msgs__msg__AvoidanceDebugMsg__rosidl_typesupport_introspection_c__AvoidanceDebugMsg_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
