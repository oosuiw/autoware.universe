...
tier4_planning_msgs__msg__VelocityLimit__create()
{
  ...
  tier4_planning_msgs__msg__VelocityLimit * msg = (tier4_planning_msgs__msg__VelocityLimit *)allocator.allocate(sizeof(tier4_planning_msgs__msg__VelocityLimit), allocator.state);
  if (!msg) {
    return NULL;
  }
...
tier4_planning_msgs__msg__VelocityLimit__Sequence__init(tier4_planning_msgs__msg__VelocityLimit__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (tier4_planning_msgs__msg__VelocityLimit *)allocator.zero_allocate(size, sizeof(tier4_planning_msgs__msg__VelocityLimit), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tier4_planning_msgs__msg__VelocityLimit__Sequence * array = (tier4_planning_msgs__msg__VelocityLimit__Sequence *)allocator.allocate(sizeof(tier4_planning_msgs__msg__VelocityLimit__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  ...
  tier4_planning_msgs__msg__VelocityLimit__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    tier4_planning_msgs__msg__VelocityLimit * data =
      (tier4_planning_msgs__msg__VelocityLimit *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tier4_planning_msgs__msg__VelocityLimit__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          tier4_planning_msgs__msg__VelocityLimit__fini(&output->data[i]);
        }
        return false;
      }
    }
