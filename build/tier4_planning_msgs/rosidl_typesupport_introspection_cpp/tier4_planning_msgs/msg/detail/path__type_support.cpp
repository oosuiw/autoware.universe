...
{
  const auto & item = *reinterpret_cast<const tier4_planning_msgs::msg::PathPoint *>(
    get_const_function__Path__points(untyped_member, index));
  auto & value = *reinterpret_cast<tier4_planning_msgs::msg::PathPoint *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<tier4_planning_msgs::msg::PathPoint *>(
    get_function__Path__points(untyped_member, index));
  const auto & value = *reinterpret_cast<const tier4_planning_msgs::msg::PathPoint *>(untyped_value);
  item = value;
}
