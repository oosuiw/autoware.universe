  ...
  std::ostream & out)
{
  ...
  // member: expand_stop_range
  {
    ...
    rosidl_generator_traits::value_to_yaml(msg.expand_stop_range, out);
  }
  out << "}";
...
inline std::string to_yaml(const ExpandStopRange & msg, bool use_flow_style = false)
{
