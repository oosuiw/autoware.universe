...
inline void to_flow_style_yaml(
  const AvoidanceDebugMsgArray & msg,
  std::ostream & out)
{
  out << "{";
  // member: header
  ...
  // member: avoidance_info
  {
    if (msg.avoidance_info.size() == 0) {
      ...
      out << "avoidance_info: [";
      size_t pending_items = msg.avoidance_info.size();
...
inline std::string to_yaml(const AvoidanceDebugMsgArray & msg, bool use_flow_style = false)
{
