  ...
  std::ostream & out)
{
  ...
  // member: is_avoidance_possible
  {
    ...
    rosidl_generator_traits::value_to_yaml(msg.is_avoidance_possible, out);
  }
  out << "}";
...
inline std::string to_yaml(const IsAvoidancePossible & msg, bool use_flow_style = false)
{
