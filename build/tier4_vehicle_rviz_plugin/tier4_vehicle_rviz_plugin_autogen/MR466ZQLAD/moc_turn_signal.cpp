...
#include <memory>
#include "../../../../src/universe/autoware.universe/common/tier4_vehicle_rviz_plugin/src/tools/turn_signal.hpp"
...
QT_INIT_METAOBJECT const QMetaObject rviz_plugins::TurnSignalDisplay::staticMetaObject = { {
    QMetaObject::SuperData::link<rviz_common::RosTopicDisplay<autoware_auto_vehicle_msgs::msg::TurnIndicatorsReport>::staticMetaObject>(),
