...
autoware_external_api_msgs__msg__ResponseStatus__create()
{
  ...
  autoware_external_api_msgs__msg__ResponseStatus * msg = (autoware_external_api_msgs__msg__ResponseStatus *)allocator.allocate(sizeof(autoware_external_api_msgs__msg__ResponseStatus), allocator.state);
  if (!msg) {
    return NULL;
  }
...
autoware_external_api_msgs__msg__ResponseStatus__Sequence__init(autoware_external_api_msgs__msg__ResponseStatus__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (autoware_external_api_msgs__msg__ResponseStatus *)allocator.zero_allocate(size, sizeof(autoware_external_api_msgs__msg__ResponseStatus), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  autoware_external_api_msgs__msg__ResponseStatus__Sequence * array = (autoware_external_api_msgs__msg__ResponseStatus__Sequence *)allocator.allocate(sizeof(autoware_external_api_msgs__msg__ResponseStatus__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  ...
  autoware_external_api_msgs__msg__ResponseStatus__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    autoware_external_api_msgs__msg__ResponseStatus * data =
      (autoware_external_api_msgs__msg__ResponseStatus *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!autoware_external_api_msgs__msg__ResponseStatus__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          autoware_external_api_msgs__msg__ResponseStatus__fini(&output->data[i]);
        }
        return false;
      }
    }
