...
#define NODE_MAIN_LOGGER_NAME "planning_validator_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libplanning_validator_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<planning_validator::PlanningValidator>";
