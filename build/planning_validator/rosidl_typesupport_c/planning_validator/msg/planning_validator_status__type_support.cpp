...
static const _PlanningValidatorStatus_type_support_symbol_names_t _PlanningValidatorStatus_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, planning_validator, msg, PlanningValidatorStatus)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, planning_validator, msg, PlanningValidatorStatus)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, planning_validator, msg, PlanningValidatorStatus)() {
  return &::planning_validator::msg::rosidl_typesupport_c::PlanningValidatorStatus_message_type_support_handle;
}
