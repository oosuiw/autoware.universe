...
#define NODE_MAIN_LOGGER_NAME "radar_scan_to_pointcloud2_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libradar_scan_to_pointcloud2_node_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<radar_scan_to_pointcloud2::RadarScanToPointcloud2Node>";
