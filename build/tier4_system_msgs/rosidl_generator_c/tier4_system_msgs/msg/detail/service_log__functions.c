...
tier4_system_msgs__msg__ServiceLog__create()
{
  ...
  tier4_system_msgs__msg__ServiceLog * msg = (tier4_system_msgs__msg__ServiceLog *)allocator.allocate(sizeof(tier4_system_msgs__msg__ServiceLog), allocator.state);
  if (!msg) {
    return NULL;
  }
...
tier4_system_msgs__msg__ServiceLog__Sequence__init(tier4_system_msgs__msg__ServiceLog__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (tier4_system_msgs__msg__ServiceLog *)allocator.zero_allocate(size, sizeof(tier4_system_msgs__msg__ServiceLog), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tier4_system_msgs__msg__ServiceLog__Sequence * array = (tier4_system_msgs__msg__ServiceLog__Sequence *)allocator.allocate(sizeof(tier4_system_msgs__msg__ServiceLog__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  ...
  tier4_system_msgs__msg__ServiceLog__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    tier4_system_msgs__msg__ServiceLog * data =
      (tier4_system_msgs__msg__ServiceLog *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tier4_system_msgs__msg__ServiceLog__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          tier4_system_msgs__msg__ServiceLog__fini(&output->data[i]);
        }
        return false;
      }
    }
