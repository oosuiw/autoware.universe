...
bool morai_msgs__msg__radar_detection__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("morai_msgs.msg._radar_detection.RadarDetection", full_classname_dest, 46) == 0);
  }
  morai_msgs__msg__RadarDetection * ros_message = _ros_message;
  {  // detection_id
  ...
  {  // rangerate
    PyObject * field = PyObject_GetAttrString(_pymsg, "rangerate");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->rangerate = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // amplitude
...
PyObject * morai_msgs__msg__radar_detection__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("morai_msgs.msg._radar_detection");
  ...
  {  // rangerate
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->rangerate);
    {
      int rc = PyObject_SetAttrString(_pymessage, "rangerate", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
