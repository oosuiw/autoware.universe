    ...
    def delta_time(self, value):
        ...
        if __debug__:
            ...
            assert \
                ...
                "The 'delta_time' field must be a set or sequence and each value of type 'float' and each float in [-340282346600000016151267322115014000640.000000, 340282346600000016151267322115014000640.000000]"
