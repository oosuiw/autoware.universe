...
morai_msgs__srv__MoraiSyncModeCmdSrv_Request__create()
{
  ...
  morai_msgs__srv__MoraiSyncModeCmdSrv_Request * msg = (morai_msgs__srv__MoraiSyncModeCmdSrv_Request *)allocator.allocate(sizeof(morai_msgs__srv__MoraiSyncModeCmdSrv_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
...
morai_msgs__srv__MoraiSyncModeCmdSrv_Request__Sequence__init(morai_msgs__srv__MoraiSyncModeCmdSrv_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (morai_msgs__srv__MoraiSyncModeCmdSrv_Request *)allocator.zero_allocate(size, sizeof(morai_msgs__srv__MoraiSyncModeCmdSrv_Request), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  morai_msgs__srv__MoraiSyncModeCmdSrv_Request__Sequence * array = (morai_msgs__srv__MoraiSyncModeCmdSrv_Request__Sequence *)allocator.allocate(sizeof(morai_msgs__srv__MoraiSyncModeCmdSrv_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  ...
  morai_msgs__srv__MoraiSyncModeCmdSrv_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    morai_msgs__srv__MoraiSyncModeCmdSrv_Request * data =
      (morai_msgs__srv__MoraiSyncModeCmdSrv_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!morai_msgs__srv__MoraiSyncModeCmdSrv_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          morai_msgs__srv__MoraiSyncModeCmdSrv_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  morai_msgs__srv__MoraiSyncModeCmdSrv_Response * msg = (morai_msgs__srv__MoraiSyncModeCmdSrv_Response *)allocator.allocate(sizeof(morai_msgs__srv__MoraiSyncModeCmdSrv_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
...
morai_msgs__srv__MoraiSyncModeCmdSrv_Response__Sequence__init(morai_msgs__srv__MoraiSyncModeCmdSrv_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (morai_msgs__srv__MoraiSyncModeCmdSrv_Response *)allocator.zero_allocate(size, sizeof(morai_msgs__srv__MoraiSyncModeCmdSrv_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  morai_msgs__srv__MoraiSyncModeCmdSrv_Response__Sequence * array = (morai_msgs__srv__MoraiSyncModeCmdSrv_Response__Sequence *)allocator.allocate(sizeof(morai_msgs__srv__MoraiSyncModeCmdSrv_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  ...
  morai_msgs__srv__MoraiSyncModeCmdSrv_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    morai_msgs__srv__MoraiSyncModeCmdSrv_Response * data =
      (morai_msgs__srv__MoraiSyncModeCmdSrv_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!morai_msgs__srv__MoraiSyncModeCmdSrv_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          morai_msgs__srv__MoraiSyncModeCmdSrv_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
