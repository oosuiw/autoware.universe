...
morai_msgs__msg__SyncModeScenarioLoad__create()
{
  ...
  morai_msgs__msg__SyncModeScenarioLoad * msg = (morai_msgs__msg__SyncModeScenarioLoad *)allocator.allocate(sizeof(morai_msgs__msg__SyncModeScenarioLoad), allocator.state);
  if (!msg) {
    return NULL;
  }
...
morai_msgs__msg__SyncModeScenarioLoad__Sequence__init(morai_msgs__msg__SyncModeScenarioLoad__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (morai_msgs__msg__SyncModeScenarioLoad *)allocator.zero_allocate(size, sizeof(morai_msgs__msg__SyncModeScenarioLoad), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  morai_msgs__msg__SyncModeScenarioLoad__Sequence * array = (morai_msgs__msg__SyncModeScenarioLoad__Sequence *)allocator.allocate(sizeof(morai_msgs__msg__SyncModeScenarioLoad__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  ...
  morai_msgs__msg__SyncModeScenarioLoad__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    morai_msgs__msg__SyncModeScenarioLoad * data =
      (morai_msgs__msg__SyncModeScenarioLoad *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!morai_msgs__msg__SyncModeScenarioLoad__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          morai_msgs__msg__SyncModeScenarioLoad__fini(&output->data[i]);
        }
        return false;
      }
    }
