...
morai_msgs__msg__RadarDetections__init(morai_msgs__msg__RadarDetections * msg)
{
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    morai_msgs__msg__RadarDetections__fini(msg);
    return false;
  }
  // detections
  if (!morai_msgs__msg__RadarDetection__Sequence__init(&msg->detections, 0)) {
    morai_msgs__msg__RadarDetections__fini(msg);
    return false;
  }
  return true;
...
morai_msgs__msg__RadarDetections__fini(morai_msgs__msg__RadarDetections * msg)
{
  ...
  // detections
  morai_msgs__msg__RadarDetection__Sequence__fini(&msg->detections);
}
...
morai_msgs__msg__RadarDetections__are_equal(const morai_msgs__msg__RadarDetections * lhs, const morai_msgs__msg__RadarDetections * rhs)
{
  ...
  // detections
  if (!morai_msgs__msg__RadarDetection__Sequence__are_equal(
  ...
  morai_msgs__msg__RadarDetections * output)
{
  ...
  // detections
  if (!morai_msgs__msg__RadarDetection__Sequence__copy(
...
morai_msgs__msg__RadarDetections__create()
{
  ...
  morai_msgs__msg__RadarDetections * msg = (morai_msgs__msg__RadarDetections *)allocator.allocate(sizeof(morai_msgs__msg__RadarDetections), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(morai_msgs__msg__RadarDetections));
  bool success = morai_msgs__msg__RadarDetections__init(msg);
  if (!success) {
...
morai_msgs__msg__RadarDetections__Sequence__init(morai_msgs__msg__RadarDetections__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  morai_msgs__msg__RadarDetections * data = NULL;

  if (size) {
    data = (morai_msgs__msg__RadarDetections *)allocator.zero_allocate(size, sizeof(morai_msgs__msg__RadarDetections), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = morai_msgs__msg__RadarDetections__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        morai_msgs__msg__RadarDetections__fini(&data[i - 1]);
      }
...
morai_msgs__msg__RadarDetections__Sequence__fini(morai_msgs__msg__RadarDetections__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      morai_msgs__msg__RadarDetections__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  morai_msgs__msg__RadarDetections__Sequence * array = (morai_msgs__msg__RadarDetections__Sequence *)allocator.allocate(sizeof(morai_msgs__msg__RadarDetections__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = morai_msgs__msg__RadarDetections__Sequence__init(array, size);
  if (!success) {
...
morai_msgs__msg__RadarDetections__Sequence__destroy(morai_msgs__msg__RadarDetections__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    morai_msgs__msg__RadarDetections__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
morai_msgs__msg__RadarDetections__Sequence__are_equal(const morai_msgs__msg__RadarDetections__Sequence * lhs, const morai_msgs__msg__RadarDetections__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!morai_msgs__msg__RadarDetections__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  morai_msgs__msg__RadarDetections__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(morai_msgs__msg__RadarDetections);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    morai_msgs__msg__RadarDetections * data =
      (morai_msgs__msg__RadarDetections *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!morai_msgs__msg__RadarDetections__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          morai_msgs__msg__RadarDetections__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!morai_msgs__msg__RadarDetections__copy(
