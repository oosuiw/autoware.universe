...
inline std::string to_yaml(const PREventSrv_Request & msg, bool use_flow_style = false)
{
...
inline std::string to_yaml(const PREventSrv_Response & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
