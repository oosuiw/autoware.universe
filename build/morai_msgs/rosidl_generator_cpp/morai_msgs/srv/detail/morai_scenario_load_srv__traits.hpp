...
inline void to_flow_style_yaml(
  const MoraiScenarioLoadSrv_Request & msg,
  std::ostream & out)
{
  out << "{";
  // member: request
...
inline std::string to_yaml(const MoraiScenarioLoadSrv_Request & msg, bool use_flow_style = false)
{
...
inline void to_flow_style_yaml(
  const MoraiScenarioLoadSrv_Response & msg,
  std::ostream & out)
{
  out << "{";
  // member: response
...
inline std::string to_yaml(const MoraiScenarioLoadSrv_Response & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
