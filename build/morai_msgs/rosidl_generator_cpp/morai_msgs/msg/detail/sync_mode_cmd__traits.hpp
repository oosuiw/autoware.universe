  ...
  std::ostream & out)
{
  ...
  {
    out << "start_sync_mode: ";
    rosidl_generator_traits::value_to_yaml(msg.start_sync_mode, out);
    out << ", ";
  }
...
inline std::string to_yaml(const SyncModeCmd & msg, bool use_flow_style = false)
{
