...
void fetch_function__ObjectStatusList__npc_list(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const morai_msgs::msg::ObjectStatus *>(
    get_const_function__ObjectStatusList__npc_list(untyped_member, index));
  auto & value = *reinterpret_cast<morai_msgs::msg::ObjectStatus *>(untyped_value);
  value = item;
}

void assign_function__ObjectStatusList__npc_list(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<morai_msgs::msg::ObjectStatus *>(
    get_function__ObjectStatusList__npc_list(untyped_member, index));
  const auto & value = *reinterpret_cast<const morai_msgs::msg::ObjectStatus *>(untyped_value);
  item = value;
}
...
void fetch_function__ObjectStatusList__pedestrian_list(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const morai_msgs::msg::ObjectStatus *>(
    get_const_function__ObjectStatusList__pedestrian_list(untyped_member, index));
  auto & value = *reinterpret_cast<morai_msgs::msg::ObjectStatus *>(untyped_value);
  value = item;
}

void assign_function__ObjectStatusList__pedestrian_list(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<morai_msgs::msg::ObjectStatus *>(
    get_function__ObjectStatusList__pedestrian_list(untyped_member, index));
  const auto & value = *reinterpret_cast<const morai_msgs::msg::ObjectStatus *>(untyped_value);
  item = value;
}
...
void fetch_function__ObjectStatusList__obstacle_list(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const morai_msgs::msg::ObjectStatus *>(
    get_const_function__ObjectStatusList__obstacle_list(untyped_member, index));
  auto & value = *reinterpret_cast<morai_msgs::msg::ObjectStatus *>(untyped_value);
  value = item;
}

void assign_function__ObjectStatusList__obstacle_list(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<morai_msgs::msg::ObjectStatus *>(
    get_function__ObjectStatusList__obstacle_list(untyped_member, index));
  const auto & value = *reinterpret_cast<const morai_msgs::msg::ObjectStatus *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ObjectStatusList_message_member_array[7] = {
  ...
  },
  {
    ...
    fetch_function__ObjectStatusList__npc_list,  // fetch(index, &value) function pointer
    assign_function__ObjectStatusList__npc_list,  // assign(index, value) function pointer
  ...
  },
  {
    ...
    fetch_function__ObjectStatusList__pedestrian_list,  // fetch(index, &value) function pointer
    assign_function__ObjectStatusList__pedestrian_list,  // assign(index, value) function pointer
  ...
  },
  {
    ...
    fetch_function__ObjectStatusList__obstacle_list,  // fetch(index, &value) function pointer
    assign_function__ObjectStatusList__obstacle_list,  // assign(index, value) function pointer
