...
static const _MoraiTLInfoSrv_Request_type_support_symbol_names_t _MoraiTLInfoSrv_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, morai_msgs, srv, MoraiTLInfoSrv_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, morai_msgs, srv, MoraiTLInfoSrv_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, morai_msgs, srv, MoraiTLInfoSrv_Request)() {
  return &::morai_msgs::srv::rosidl_typesupport_c::MoraiTLInfoSrv_Request_message_type_support_handle;
}
...
static const _MoraiTLInfoSrv_Response_type_support_symbol_names_t _MoraiTLInfoSrv_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, morai_msgs, srv, MoraiTLInfoSrv_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, morai_msgs, srv, MoraiTLInfoSrv_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, morai_msgs, srv, MoraiTLInfoSrv_Response)() {
  return &::morai_msgs::srv::rosidl_typesupport_c::MoraiTLInfoSrv_Response_message_type_support_handle;
}
...
static const _MoraiTLInfoSrv_type_support_symbol_names_t _MoraiTLInfoSrv_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, morai_msgs, srv, MoraiTLInfoSrv)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, morai_msgs, srv, MoraiTLInfoSrv)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, morai_msgs, srv, MoraiTLInfoSrv)() {
  return &::morai_msgs::srv::rosidl_typesupport_c::MoraiTLInfoSrv_service_type_support_handle;
}
