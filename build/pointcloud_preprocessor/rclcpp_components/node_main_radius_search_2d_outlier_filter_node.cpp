...
#define NODE_MAIN_LOGGER_NAME "radius_search_2d_outlier_filter_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<pointcloud_preprocessor::RadiusSearch2DOutlierFilterComponent>";
