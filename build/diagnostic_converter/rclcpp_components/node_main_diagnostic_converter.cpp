...
#define NODE_MAIN_LOGGER_NAME "diagnostic_converter"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libdiagnostic_converter_node.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<diagnostic_converter::DiagnosticConverter>";
