...
tier4_debug_msgs__msg__Int32Stamped__create()
{
  ...
  tier4_debug_msgs__msg__Int32Stamped * msg = (tier4_debug_msgs__msg__Int32Stamped *)allocator.allocate(sizeof(tier4_debug_msgs__msg__Int32Stamped), allocator.state);
  if (!msg) {
    return NULL;
  }
...
tier4_debug_msgs__msg__Int32Stamped__Sequence__init(tier4_debug_msgs__msg__Int32Stamped__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (tier4_debug_msgs__msg__Int32Stamped *)allocator.zero_allocate(size, sizeof(tier4_debug_msgs__msg__Int32Stamped), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tier4_debug_msgs__msg__Int32Stamped__Sequence * array = (tier4_debug_msgs__msg__Int32Stamped__Sequence *)allocator.allocate(sizeof(tier4_debug_msgs__msg__Int32Stamped__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  ...
  tier4_debug_msgs__msg__Int32Stamped__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    tier4_debug_msgs__msg__Int32Stamped * data =
      (tier4_debug_msgs__msg__Int32Stamped *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tier4_debug_msgs__msg__Int32Stamped__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          tier4_debug_msgs__msg__Int32Stamped__fini(&output->data[i]);
        }
        return false;
      }
    }
