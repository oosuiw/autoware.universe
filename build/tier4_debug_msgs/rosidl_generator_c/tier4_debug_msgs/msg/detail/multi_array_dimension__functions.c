...
tier4_debug_msgs__msg__MultiArrayDimension__create()
{
  ...
  tier4_debug_msgs__msg__MultiArrayDimension * msg = (tier4_debug_msgs__msg__MultiArrayDimension *)allocator.allocate(sizeof(tier4_debug_msgs__msg__MultiArrayDimension), allocator.state);
  if (!msg) {
    return NULL;
  }
...
tier4_debug_msgs__msg__MultiArrayDimension__Sequence__init(tier4_debug_msgs__msg__MultiArrayDimension__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (tier4_debug_msgs__msg__MultiArrayDimension *)allocator.zero_allocate(size, sizeof(tier4_debug_msgs__msg__MultiArrayDimension), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tier4_debug_msgs__msg__MultiArrayDimension__Sequence * array = (tier4_debug_msgs__msg__MultiArrayDimension__Sequence *)allocator.allocate(sizeof(tier4_debug_msgs__msg__MultiArrayDimension__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  ...
  tier4_debug_msgs__msg__MultiArrayDimension__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    tier4_debug_msgs__msg__MultiArrayDimension * data =
      (tier4_debug_msgs__msg__MultiArrayDimension *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tier4_debug_msgs__msg__MultiArrayDimension__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          tier4_debug_msgs__msg__MultiArrayDimension__fini(&output->data[i]);
        }
        return false;
      }
    }
