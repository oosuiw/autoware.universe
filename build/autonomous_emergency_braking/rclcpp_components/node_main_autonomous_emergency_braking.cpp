...
#define NODE_MAIN_LOGGER_NAME "autonomous_emergency_braking"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libautonomous_emergency_braking_node.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<autoware::motion::control::autonomous_emergency_braking::AEB>";
