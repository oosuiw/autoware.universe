...
#include "autoware_perception_msgs/msg/detail/traffic_light__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const autoware_perception_msgs::msg::TrafficLight *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<autoware_perception_msgs::msg::TrafficLight *>(
    untyped_ros_message);
...
{
  return &autoware_perception_msgs::msg::typesupport_fastrtps_cpp::_TrafficLight__handle;
}
