...
#define NODE_MAIN_LOGGER_NAME "bytetrack_node_exe"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libbytetrack_node.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<bytetrack::ByteTrackNode>";
