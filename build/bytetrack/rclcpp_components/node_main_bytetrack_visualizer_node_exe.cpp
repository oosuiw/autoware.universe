...
#define NODE_MAIN_LOGGER_NAME "bytetrack_visualizer_node_exe"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libbytetrack_visualizer.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<bytetrack::ByteTrackVisualizerNode>";
