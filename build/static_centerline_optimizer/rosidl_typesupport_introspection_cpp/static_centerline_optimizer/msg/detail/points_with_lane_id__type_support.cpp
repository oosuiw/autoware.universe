...
void fetch_function__PointsWithLaneId__points(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const geometry_msgs::msg::Point *>(
    get_const_function__PointsWithLaneId__points(untyped_member, index));
  auto & value = *reinterpret_cast<geometry_msgs::msg::Point *>(untyped_value);
  value = item;
}

void assign_function__PointsWithLaneId__points(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<geometry_msgs::msg::Point *>(
    get_function__PointsWithLaneId__points(untyped_member, index));
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember PointsWithLaneId_message_member_array[2] = {
  ...
  },
  {
    ...
    fetch_function__PointsWithLaneId__points,  // fetch(index, &value) function pointer
    assign_function__PointsWithLaneId__points,  // assign(index, value) function pointer
