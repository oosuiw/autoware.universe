...
static_centerline_optimizer__srv__PlanRoute_Request__create()
{
  ...
  static_centerline_optimizer__srv__PlanRoute_Request * msg = (static_centerline_optimizer__srv__PlanRoute_Request *)allocator.allocate(sizeof(static_centerline_optimizer__srv__PlanRoute_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
...
static_centerline_optimizer__srv__PlanRoute_Request__Sequence__init(static_centerline_optimizer__srv__PlanRoute_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (static_centerline_optimizer__srv__PlanRoute_Request *)allocator.zero_allocate(size, sizeof(static_centerline_optimizer__srv__PlanRoute_Request), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  static_centerline_optimizer__srv__PlanRoute_Request__Sequence * array = (static_centerline_optimizer__srv__PlanRoute_Request__Sequence *)allocator.allocate(sizeof(static_centerline_optimizer__srv__PlanRoute_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  ...
  static_centerline_optimizer__srv__PlanRoute_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    static_centerline_optimizer__srv__PlanRoute_Request * data =
      (static_centerline_optimizer__srv__PlanRoute_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!static_centerline_optimizer__srv__PlanRoute_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          static_centerline_optimizer__srv__PlanRoute_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  static_centerline_optimizer__srv__PlanRoute_Response * msg = (static_centerline_optimizer__srv__PlanRoute_Response *)allocator.allocate(sizeof(static_centerline_optimizer__srv__PlanRoute_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
...
static_centerline_optimizer__srv__PlanRoute_Response__Sequence__init(static_centerline_optimizer__srv__PlanRoute_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (static_centerline_optimizer__srv__PlanRoute_Response *)allocator.zero_allocate(size, sizeof(static_centerline_optimizer__srv__PlanRoute_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  static_centerline_optimizer__srv__PlanRoute_Response__Sequence * array = (static_centerline_optimizer__srv__PlanRoute_Response__Sequence *)allocator.allocate(sizeof(static_centerline_optimizer__srv__PlanRoute_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  ...
  static_centerline_optimizer__srv__PlanRoute_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    static_centerline_optimizer__srv__PlanRoute_Response * data =
      (static_centerline_optimizer__srv__PlanRoute_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!static_centerline_optimizer__srv__PlanRoute_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          static_centerline_optimizer__srv__PlanRoute_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
